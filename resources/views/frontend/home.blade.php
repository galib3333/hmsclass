...
@section('content')
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h4 class="mt-3 me-5"><a href="index.html" class="logo me-auto "><img class="mx-2 mb-2"
                        src="{{ asset('public/frontassets/img/logo-dark.png') }}" alt="">NewLife</a></h4>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <h1 class="logo me-auto"><a href="index.html">NewLife</a></h1> -->
        ...
        <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active"
                    style="background-image: url({{ asset('public/frontassets/img/slide/slide-1.jpg)') }}">
                    <div class="container">
                        <h2>Welcome to <span>NewLife</span></h2>
                ...
                <div class="carousel-item"
                    style="background-image: url({{ asset('public/frontassets/img/slide/slide-2.jpg)') }}">
                    <div class="container">
                ...
                <!-- Slide 3 -->
                <div class="carousel-item"
                    style="background-image: url({{ asset('public/frontassets/img/slide/slide-3.jpg)') }}">
                    <div class="container">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-right">
                        <img src="{{ asset('public/frontassets/img/about.jpg') }}" class="img-fluid" alt="">
                    </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="image col-lg-6 order-1 order-lg-2"
                        style='background-image: url("{{ asset('public/frontassets/img/features.jpg') }}");'
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('appStore') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group mt-3">
                                            <select name="department_id"
                                                onchange="$('.dept').hide();$('.dept'+this.value).show()"
                                                id="department_id" class="form-select">
                                        ...
                                        <div class="col-md-4 form-group mt-3">
                                            <select name="doctor_id" id="doctor_id" class="form-select">
                                                ...
                                                @forelse($doctor as $dep)
                                                    <option class="dept dept{{ $dep->department_id }}"
                                                        value="{{ $dep->employ_id }}">{{ $dep->employ->name_en }}
                                                    </option>
                                                @empty
                                                @endforelse
                                            </select>
                                    ...
                                    <div class="form-group mt-3">
                                        <textarea class="form-control" name="details" rows="5" placeholder="Problem"></textarea>
                                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tab-1">
                                ...
                                <img src="{{ asset('public/frontassets/img/departments-1.jpg') }}" alt=""
                                    class="img-fluid">
                            ...
                            <div class="tab-pane" id="tab-2">
                                ...
                                <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde
                                    sonata raqer a videna mareta paulona marka</p>
                                <img src="{{ asset('public/frontassets/img/departments-2.jpg') }}" alt=""
                                    class="img-fluid">
                                <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos
                                    ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima eveniet
                                    eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique accusamus
                            ...
                            <div class="tab-pane" id="tab-3">
                                ...
                                <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde
                                    sonata raqer a videna mareta paulona marka</p>
                                <img src="{{ asset('public/frontassets/img/departments-3.jpg') }}" alt=""
                                    class="img-fluid">
                                <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos
                                    ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima eveniet
                                    eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique accusamus
                            ...
                            <div class="tab-pane" id="tab-4">
                                ...
                                <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde
                                    sonata raqer a videna mareta paulona marka</p>
                                <img src="{{ asset('public/frontassets/img/departments-4.jpg') }}" alt=""
                                    class="img-fluid">
                                <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos
                                    ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima eveniet
                                    eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique accusamus
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('public/frontassets/img/testimonials/testimonials-1.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('public/frontassets/img/testimonials/testimonials-2.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Sara Wilsson</h3>
                                <h4>Designer</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('public/frontassets/img/testimonials/testimonials-3.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Jena Karlis</h3>
                                <h4>Store Owner</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('public/frontassets/img/testimonials/testimonials-4.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Matt Brandon</h3>
                                <h4>Freelancer</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('public/frontassets/img/testimonials/testimonials-5.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>John Larson</h3>
                                <h4>Entrepreneur</h4>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="100">
                            <div class="member-img">
                                <img src="{{ asset('public/frontassets/img/doctors/doctors-1.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('public/frontassets/img/doctors/doctors-2.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="300">
                            <div class="member-img">
                                <img src="{{ asset('public/frontassets/img/doctors/doctors-3.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="400">
                            <div class="member-img">
                                <img src="{{ asset('public/frontassets/img/doctors/doctors-4.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                ...
                <div class="gallery-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="{{ asset('public/frontassets/img/gallery/gallery-1.jpg') }}"><img
                                    src="{{ asset('public/frontassets/img/gallery/gallery-1.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="{{ asset('public/frontassets/img/gallery/gallery-2.jpg') }}"><img
                                    src="{{ asset('public/frontassets/img/gallery/gallery-2.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="{{ asset('public/frontassets/img/gallery/gallery-3.jpg') }}"><img
                                    src="{{ asset('public/frontassets/img/gallery/gallery-3.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="{{ asset('public/frontassets/img/gallery/gallery-4.jpg') }}"><img
                                    src="{{ asset('public/frontassets/img/gallery/gallery-4.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="{{ asset('public/frontassets/img/gallery/gallery-5.jpg') }}"><img
                                    src="{{ asset('public/frontassets/img/gallery/gallery-5.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="{{ asset('public/frontassets/img/gallery/gallery-6.jpg') }}"><img
                                    src="{{ asset('public/frontassets/img/gallery/gallery-6.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="{{ asset('public/frontassets/img/gallery/gallery-7.jpg') }}"><img
                                    src="{{ asset('public/frontassets/img/gallery/gallery-7.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="{{ asset('public/frontassets/img/gallery/gallery-8.jpg') }}"><img
                                    src="{{ asset('public/frontassets/img/gallery/gallery-8.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                    </div>
                    <div class="swiper-pagination"></div>
                </div>
    ...
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>NewLife</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
                <!-- All the links in the footer should remain intact. -->
                <!-- You can delete the links only if you purchased the pro version. -->
                <!-- Licensing information: https://bootstrapmade.com/license/ -->
                <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/NewLife-free-bootstrap-theme/ -->
                Designed by <a href="https://timelord.com/">TimeLord</a>
            </div>
        </div>
    </footer><!-- End Footer -->
