                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs top-icon nav-justified" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" href="javascript:void();" data-bs-target="#app" data-bs-toggle="pill"
                                            class="nav-link active"><span
                                                class="hidden-xs text-success fw-bold">Appointment</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="javascript:void();" data-bs-target="#reg" data-bs-toggle="pill"
