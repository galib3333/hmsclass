...
@section('title', trans('Update Doctor'))
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-title">Doctor Update Form</div>
                        <hr>
                        <form method="post" enctype="multipart/form-data"
                            action="{{ route('doctor.update', encryptor('encrypt', $doctor->id)) }}">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="uptoken" value="{{ encryptor('encrypt', $doctor->id) }}">
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select class="form-control" name="employId" id="employId">
                                        ...
                                        @forelse($employee as $e)
                                            <option value="{{ $e->id }}"
                                                {{ old('employId', $doctor->employ_id) == $e->id ? 'selected' : '' }}>
                                                {{ $e->name_en }}</option>
                                        @empty
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select class="form-control" name="departmentId" id="departmentId">
                                        ...
                                        @forelse($department as $d)
                                            <option value="{{ $d->id }}"
                                                {{ old('departmentId', $doctor->department_id) == $d->id ? 'selected' : '' }}>
                                                {{ $d->dep_name }}</option>
                                        @empty
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select class="form-control" name="designationId" id="designationId">
                                        ...
                                        @forelse($designation as $des)
                                            <option value="{{ $des->id }}"
                                                {{ old('designationId', $doctor->designation_id) == $des->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <textarea class="form-control" id="biography" name="biography" value="{{ old('biography', $doctor->biography) }}"
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="specialist" name="specialist"
                                        value="{{ old('specialist', $doctor->specialist) }}" placeholder="Enter specialization">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <textarea class="form-control" id="education" name="education" value="{{ old('education', $doctor->education) }}"
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="fees" name="fees"
                                        value="{{ old('fees', $doctor->fees) }}" placeholder="Enter Fee">
                                    @if ($errors->has('fees'))
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select id="status" class="form-control" name="status">
                                            <option value="" @if (old('status', $doctor->status) === null) selected @endif>Select
                                                Status</option>
                                            <option value="1" @if (old('status', $doctor->status) == 1) selected @endif>Active
                                            </option>
                                            <option value="0" @if (old('status', $doctor->status) == 0)  @endif>
                                                Inactive</option>
                                        </select>
