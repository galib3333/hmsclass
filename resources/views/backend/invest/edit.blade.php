...
@section('title', trans('Update Investigation'))
    ...
    <div class="container-fluid">
        <div class="row mt-3">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('invest.index') }}" class="btn btn-light px-2 mb-3">Investigation List<i
                                class="fa fa-list px-2"></i></a>
                        <div class="card-title">Investigation Update Form</div>
                        <hr>
                        <form method="post" action="{{ route('invest.update', encryptor('encrypt', $invest->id)) }}"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="uptoken" value="{{ encryptor('encrypt', $invest->id) }}">
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select class="form-control" name="invCatId" id="invCatId">
                                        ...
                                        @forelse($investCat as $ic)
                                            <option value="{{ $ic->id }}"
                                                {{ old('invCatId', $invest->inv_cat_id) == $ic->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="invsetName" name="invsetName"
                                        value="{{ old('invsetName', $invest->invset_name) }}" placeholder="Enter Room Number">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <textarea type="text" class="form-control" id="description" name="description" value=""
                                        placeholder="Enter Room Description">{{ old('description', $invest->description) }}</textarea>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price"
                                        value="{{ old('price', $invest->price) }}" placeholder="Enter Room Price">
                                    @if ($errors->has('price'))
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select id="status" class="form-control" name="status">
                                            ...
                                            <option value="1" @if (old('status', $invest->status) == 1) selected @endif>Active
                                            </option>
                                            <option value="0" @if (old('status', $invest->status) == 0) selected @endif>
                                                Inactive</option>
                                        </select>
