...
@section('title', trans('Create Patient Admit'))
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="husbandName" name="husbandName"
                                        value="{{ old('husbandName') }}" placeholder="Enter Husband's Name">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="relation" name="relation"
                                        value="{{ old('relation') }}" placeholder="Enter Relation With Guardian">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="condition" name="condition"
                                        value="{{ old('condition') }}" placeholder="Enter Patient's Condition">
