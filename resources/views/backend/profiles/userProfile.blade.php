                ...
                <div class="card profile-card-2">
                    ...
                    <div class="card-body border-top border-light">
                        <div class="media align-items-center">
                            <div>
                                <img src="{{ asset('public/assets/images/timeline/html5.svg') }}" class="skill-img"
                                    alt="skill img">
                            </div>
                        ...
                        <hr>
                        <div class="media align-items-center">
                            <div><img src="{{ asset('public/assets/images/timeline/bootstrap-4.svg') }}" class="skill-img"
                                    alt="skill img">
                            </div>
                            <div class="media-body text-left ml-3">
                                <div class="progress-wrapper">
                        ...
                        <hr>
                        <div class="media align-items-center">
                            <div><img src="{{ asset('public/assets/images/timeline/angular-icon.svg') }}" class="skill-img"
                                    alt="skill img">
                            </div>
                            <div class="media-body text-left ml-3">
                                <div class="progress-wrapper">
                        ...
                        <hr>
                        <div class="media align-items-center">
                            <div><img src="{{ asset('public/assets/images/timeline/react.svg') }}" class="skill-img"
                                    alt="skill img"></div>
                            <div class="media-body text-left ml-3">
                                <div class="progress-wrapper">
