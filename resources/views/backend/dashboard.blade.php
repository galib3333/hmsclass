    ...
    <div class="card mt-3">
        <div class="card-content">
            <div class="row row-group m-0">
                ...
                <div class="col-12 col-lg-6 col-xl-3 border-light">
                    <div class="card-body">
                        <h5 class="text-white mb-0">{{$totalAppointments}}<span class="float-right"><i class="fa-solid fa-prescription"></i></span></h5>
                        <div class="progress my-3" style="height:3px;">
                            <div class="progress-bar" style="width:55%"></div>
                        </div>
                ...
                <div class="col-12 col-lg-6 col-xl-3 border-light">
                    <div class="card-body">
                        <h5 class="text-white mb-0">{{$totalPatientAdmit}}<span class="float-right"><i class="fa fa-ambulance" aria-hidden="true"></i></span></h5>
                        <div class="progress my-3" style="height:3px;">
                            <div class="progress-bar" style="width:55%"></div>
                        </div>
