...
<head>
    ...
    <title>@yield('title','Preclinic Hospital Management System')</title>
</head>
        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="{{ asset('public/assets/img/logo.png')}}" width="35" height="35" alt=""> <span>Preclinic</span>
				</a>
			</div>
            ...
            <ul class="nav user-menu float-right">
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
											<span class="avatar">
												<img alt="John Doe" src="{{ asset('public/assets/img/user.jpg')}}" class="img-fluid">
											</span>
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img">
							<img class="rounded-circle" src="{{ asset('public/assets/img/user.jpg')}}" width="24" alt="Admin">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li>
							<a href="{{ asset('public/assets.html')}}"><i class="fa fa-cube"></i> <span>Assets</span></a>
						</li>
						<li>
